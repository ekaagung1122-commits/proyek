...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $basecampIds = Basecamp::whereIn(
            'gunung_id',
            $gunungIds
        )->pluck('id');

        $bookingQuery = Booking::whereIn(
            'basecamp_id',
            $basecampIds
        );
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'admin_basecamp_aktif' => User::whereHas(
                    'roles',
                    function ($query) {
    ...
    public function chart()
    {
        ...
        $bookingStatusDistribution = Booking::whereIn(
            'basecamp_id',
            $basecampIds
        )
